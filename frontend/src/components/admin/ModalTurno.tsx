  ...
  return (
    ...
    >
      <div className="flex flex-col gap-5">
        ...
        {/* HU-34 — El color de este turno en la grilla. Solo sobre un pendiente: es el
            único estado en el que el color se ve, porque el realizado y el ausente se
            pintan con el verde y el rojo de siempre. */}
        {esReservado && <ColorDelTurno turno={turno} />}
